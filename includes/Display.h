...
#define STATS_BAR_HEIGHT 17
#define STATS_BAR_BORDER_X 300
#define STATS_BAR_BORDER_Y 0
...
#define ACTION_QUEUE_WIDTH (SCREEN_WIDTH_GLOBAL / 3.5)
#define ACTION_QUEUE_HEIGHT (SCREEN_WIDTH_GLOBAL / 4)
#define ACTION_QUEUE_X (SCREEN_WIDTH_GLOBAL / 2 - ACTION_QUEUE_WIDTH / 2)
#define ACTION_QUEUE_Y (SCREEN_HEIGHT_GLOBAL - TERMINAL_WINDOW_HEIGHT)
